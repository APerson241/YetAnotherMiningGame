...
public class WelcomeView {
	...
	private class ImagePanel extends JPanel implements MouseListener {
		...
		private void paintBackgroundAndStuff(Graphics g) {
			...
			drawText(g, xCoordOfANSP, 150, 50, stringShownANSP.toString().split(" "));
		...
		public void paintComponent(Graphics g) {
			...
			case 3:
				...
				int dummy = drawText(g, 523, 75, 30, "6/21/12: v0.9 of YAMG comes out.",
